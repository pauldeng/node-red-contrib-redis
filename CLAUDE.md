...
This project is a Node-RED custom node package implemented in JavaScript ES6+ with Node.js v24 as the working runtime target, Node-RED v5.0.1 as the editor/runtime target, and ioredis v5.11.1 as the Redis client.
