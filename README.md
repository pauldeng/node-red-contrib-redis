...
| Redis / Valkey server    | Redis 6.2.3+ / Valkey 7.2.5+; Redis 8.10 is the primary tested target             |
| Redis deployments tested | Standalone (TCP or Unix socket), ACL auth, Cluster, Sentinel, AWS MemoryDB opt-in |
