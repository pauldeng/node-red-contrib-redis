...
### 11. Update documentation and agent guidance
...
### 12. Preserve and extend release publishing
...
- Extend the existing release gate with the new minimum-version compatibility suite. Continue
  running formatting, production audit, the modern Docker suite, Playwright, package
  inspection, and release-tag/package-version equality before publishing.
