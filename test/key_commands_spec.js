...
describe("Key commands", () => {
  ...
  it(
    "should EXISTS return 1 for existing key and 0 for missing",
    { timeout: 5000 },
    function (t, done) {
      const flow = [
        configNode,
  ...
  it("should TYPE return the type of a key", { timeout: 5000 }, function (t, done) {
    const flow = [
      configNode,
      {
        id: "set-node",
  ...
  it("should RENAME a key to a new name", { timeout: 5000 }, function (t, done) {
    const flow = [
      configNode,
      {
        id: "set-node",
  ...
  it(
    "should RENAMENX rename only if new name does not exist",
    { timeout: 5000 },
    function (t, done) {
      const flow = [
        configNode,
  ...
  it(
    "should EXPIRE set TTL and TTL return remaining seconds",
    { timeout: 5000 },
    function (t, done) {
      const flow = [
        configNode,
  ...
  it("should EXPIREAT set TTL by Unix timestamp", { timeout: 5000 }, function (t, done) {
    const flow = [
      configNode,
      {
        id: "set-node",
  ...
  it(
    "should PEXPIRE set millisecond TTL and PTTL return remaining ms",
    { timeout: 5000 },
    function (t, done) {
      const flow = [
        configNode,
  ...
  it(
    "should PEXPIREAT set millisecond TTL by Unix timestamp",
    { timeout: 5000 },
    function (t, done) {
      const flow = [
        configNode,
  ...
  it("should PERSIST remove TTL and make key permanent", { timeout: 5000 }, function (t, done) {
    const flow = [
      configNode,
      {
        id: "setex-node",
  ...
  it(
    "should TOUCH update access time and return number of touched keys",
    { timeout: 5000 },
    function (t, done) {
      const flow = [
        configNode,
  ...
  it("should UNLINK asynchronously delete a key", { timeout: 5000 }, function (t, done) {
    const flow = [
      configNode,
      {
        id: "set-node",
  ...
  it("should KEYS return matching key names", { timeout: 5000 }, function (t, done) {
    const flow = [
      configNode,
      {
        id: "mset-node",
  ...
  it("should SCAN iterate over keys with a cursor", { timeout: 5000 }, function (t, done) {
    const flow = [
      configNode,
      {
        id: "scan-node",
  ...
  it("should COPY duplicate a key to a new destination", { timeout: 5000 }, function (t, done) {
    const flow = [
      configNode,
      {
        id: "set-node",
  ...
  it("should SORT a list and return sorted elements", { timeout: 5000 }, function (t, done) {
    const flow = [
      configNode,
      {
        id: "rpush-node",
  ...
  it(
    "should EXPIRETIME return the expiry as unix timestamp",
    { timeout: 5000 },
    function (t, done) {
      const flow = [
        configNode,
  ...
  it(
    "should PEXPIRETIME return the expiry as millisecond timestamp",
    { timeout: 5000 },
    function (t, done) {
      const flow = [
        configNode,
  ...
  it(
    "should DUMP serialize a key and RESTORE deserialize it",
    { timeout: 5000 },
    function (t, done) {
      const flow = [
        configNode,
  ...
  it(
    "should SORT_RO return sorted elements without modifying the list",
    { timeout: 5000 },
    function (t, done) {
      const flow = [
        configNode,
  ...
  it("should RANDOMKEY return a random existing key", { timeout: 5000 }, function (t, done) {
    const flow = [
      configNode,
      {
        id: "set-node",
