...
describeSentinel("Redis Sentinel auth deployment", () => {
  ...
  it(
    "runs command and simple Lua coverage through Sentinel discovery",
    { timeout: 40000 },
    async function () {
  ...
  it(
    "runs FCALL and read-only EVAL through Sentinel discovery",
    { timeout: 40000 },
    async function () {
      const lib = [
  ...
  it(
    "runs block-mode (dedicated connection) Script and Function through Sentinel",
    { timeout: 40000 },
    async function () {
      ...
      await waitForNodeProp(fnNode, "libname");
      (
        await invoke(helper, "blk-fn", { payload: ["test:sentinel:blkfn", "f-value"] })
  ...
  it("supports pub/sub and blocking list input nodes", { timeout: 40000 }, async function () {
  ...
  it(
    "runs Redis 7.2 cluster-prone commands through Sentinel",
    { timeout: 40000 },
    async function () {
      const script =
  ...
  it("reconnects through Sentinel after a failover", { timeout: 40000 }, async function () {
    const flow = commandFlow([
      { id: "set", command: "SET" },
      { id: "get", command: "GET" },
    ]);
