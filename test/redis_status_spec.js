...
const { badRedisConfigNode, redisConfigNode } = require("./helpers/deployment");
...
describe("node connection status", function () {
  ...
  // dereferenced it — a generic, confusing TypeError. getConn() now throws a
  // clear error itself so no caller ever attaches listeners to an undefined
